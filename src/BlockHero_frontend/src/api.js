...
async function registerUser(identity, userId, userPw, userAuthority) {
  try {
...
async function checkUserRegistered(identity) {
  try {
...
async function login(identity, userId, userPw) {
  try {
...
async function uploadFile(title, content, fileAuthority) {
  try {
...
async function readFile(title, identity) {
  try {
...
async function readLogs(limit, order) {
  try {
